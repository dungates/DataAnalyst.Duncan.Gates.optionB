...
ggplot(text_additional_comments_graph, aes(word, n, fill = -n)) +
  ...
  labs(x = "", y = "", title = "Top 10 Additional Comments Words without Non-Responses") + 
  coord_flip() +
  theme_bw() +
  theme(
          legend.position = "none",
...
ggplot(text_improved_experience_graph, aes(reorder(word, n), n, fill = -n)) +
  ...
  scale_color_manual(values = c(col(nrow(text_additional_comments_graph)))) +
  geom_text(aes(label = n), hjust = -0.14, family = "Oswald") +
  labs(x = "", y = "", title = "Top 10 Words for What Could Have Improved Experience") + 
  coord_flip() +
  theme_bw() +
  theme(
          legend.position = "none",
...
ggplot(text_professional_learning_graph, aes(reorder(word, n), n, fill = -n)) +
  ...
  geom_text(aes(label = n), hjust = -0.14, family = "Oswald") +
  labs(x = "", y = "", title = "Top 10 Words for What Went Well in the Learning Experience") + 
  coord_flip() +
  theme_bw() +
  theme(
          legend.position = "none",
...
ggplot(bigrams_united_graph, aes(reorder(word, n), n, fill = -n)) +
  ...
  scale_y_continuous(breaks = scales::breaks_pretty(n = 8)) +
  geom_text(aes(label = n), hjust = -0.14, family = "Oswald") +
  labs(x = "", y = "", title = "Top 10 Bigrams (Two Word Combinations)") + 
  coord_flip() +
  theme_bw() +
  theme(
          legend.position = "none",
...
ggplot(trigrams_united_graph, aes(reorder(word, n), n, fill = -n)) +
    ...
    geom_text(aes(label = n), hjust = -0.14, family = "Oswald") +
    labs(x = "", y = "", title = "Top 10 Trigrams") + 
    coord_flip() +
  theme_bw() +
  theme(
          legend.position = "none",
